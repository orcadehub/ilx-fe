...
const roles = [
  ...
  },
  {
    type: "admin",
    label: "Administrator",
    desc: "Manage platform activities and users",
  ...
  return (
    <div>
      ...
      <div className="text-center mb-3">
        ...
        >
          Sign in to InfluenceConnect
        </h2>
        <p style={{ color: "#6B7280", margin: 0, fontSize: "1.03rem" }}>
          Choose how to access your account
        </p>
      </div>
      ...
      <div className="text-center mt-4" style={{ color: "#6B7280" }}>
        ...
        <a
          href="/signup"
          style={{ color: "#5357EB", fontWeight: 700, textDecoration: "none" }}
        >
          Sign up
        </a>
      </div>
